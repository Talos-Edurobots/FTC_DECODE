...
public class REVStarterBotTeleOpJava extends LinearOpMode {
    ...
    private static final int maxVelocity = 2440;

    private boolean isFlywheelTargetVel = false;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                telemetry.addData("is flywheel on correct velocity", isFlywheelTargetVel);
                telemetry.addData("Flywheel Velocity", ((DcMotorEx) flywheel).getVelocity());
                telemetry.addData("Flywheel Power", flywheel.getPower());
                telemetry.addData("Flywheel current", ((DcMotorEx) flywheel).getCurrent(CurrentUnit.AMPS));
